...
import com.example.learningproject.driverapp.activity.HomeViewModelFragment;
...
public class HomeFragment extends Fragment implements OnMapReadyCallback ,HomeFragmentListener.ShowMessageListener {
    ...
    private View root;
    private HomeViewModelFragment homeViewModel;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        homeViewModel = new ViewModelProvider(this).get(HomeViewModelFragment.class);
