...
import com.example.learningproject.entireactivity.apiRetrofit.IFCMService;
...
import com.example.learningproject.entireactivity.notification.Notification;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        mFCMService = CommonUrl.getFCMService();
...
public void onClick(View v) {
        ...
        {
        pickupLocation = CommonUrl.mLastLocation;
        ...
        {
        calculateCashFee(pickupLocation,CommonUrl.mLastLocation);
...
public void onResponse(Call<String> call, Response<String> response) {
        ...
        intent.putExtra("total",CommonUrl.formulaPrice(distance_value,time_value));
        intent.putExtra("location_start",String.format("%f,%f",pickupLocation.getLatitude(),pickupLocation.getLongitude()));
        intent.putExtra("location_end",String.format("%f,%f",CommonUrl.mLastLocation.getLatitude(),CommonUrl.mLastLocation.getLongitude()));
...
public void onMapReady(GoogleMap googleMap) {
        ...
        geoFire = new GeoFire(FirebaseDatabase.getInstance().getReference(CommonUrl.driver_tb1));
...
private void sendArrivedNotification(String customerId) {
        ...
        Notification notification = new Notification("Arrived",String.format("The driver %s has arrived at your location",CommonUrl.currentUser.getName()));
...
private void displayLocation() {
        ...
        CommonUrl.mLastLocation = LocationServices.FusedLocationApi.getLastLocation(mGoogleApiClient);

        final double latitude = CommonUrl.mLastLocation.getLatitude();
        final double longitude = CommonUrl.mLastLocation.getLongitude();
...
private void getDirecton() {
        ...
        LatLng currentPosition = new LatLng(CommonUrl.mLastLocation.getLatitude(), CommonUrl.mLastLocation.getLongitude());
...
public void onLocationChanged(Location location) {
        CommonUrl.mLastLocation = location;
        displayLocation();
