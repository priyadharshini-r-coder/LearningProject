...
import com.example.learningproject.databinding.ActivityCallDriverBinding;
...
public class CallDriverActivity extends AppCompatActivity {
    ...
    ActivityCallDriverBinding binding;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding= DataBindingUtil.setContentView(this,R.layout.activity_call_driver);
        ...
        binding.btnCallDriver.setOnClickListener(new View.OnClickListener() {
            @Override
