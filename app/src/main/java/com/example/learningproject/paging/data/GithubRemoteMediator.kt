package com.example.learningproject.paging.data
...
import com.example.learningproject.paging.api.IN_QUALIFIER
import com.example.learningproject.paging.db.RemoteKeys
import com.example.learningproject.paging.db.RepoDatabase
import com.example.learningproject.paging.model.Repo
...
class GithubRemoteMediator (private val query:String,
    ...
    position->
    position?.let {
        state.closestItemToPosition(it)?.id?.let { repoId->
